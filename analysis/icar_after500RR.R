...
rhats.after500rr  <- coda::gelman.diag(icar.samples)
icar.after500rr  <- do.call(rbind.data.frame,icar.samples)
save(rhats.after500rr,icar.after500rr,file=here('results','icar_after500RR.RData'))
