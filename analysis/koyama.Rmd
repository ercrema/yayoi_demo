...
correct_perdiod=read.csv("yayoiduration.csv")
Cyh=1000/abs(sapply(gsub("BC","-",correct_perdiod[3:9]),function(i)eval(parse(text=i))))
names(Cyh)=colnames(correct_perdiod)[3:9]
