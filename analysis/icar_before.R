...
rhats.before  <- coda::gelman.diag(icar.samples)
icar.before  <- do.call(rbind.data.frame,icar.samples)
save(icar.before,rhats.before,file=here('results','icar_before.RData'))
