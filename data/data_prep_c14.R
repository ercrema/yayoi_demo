...
# Read 14C Data ----
c14db  <- read.csv(here('data','rekihaku_downloads','c14db_1.1.0.csv'))
...
c14db$medCal  <- medCal(calibrated.dates)
...
c14db$D500[intersect(which.CalDates(calibrated.dates,BP<(2988+500)&BP>(2988-500),p=0.5),which(c14db$RiceRegion=='I'))] <- TRUE
c14db$D500[intersect(which.CalDates(calibrated.dates,BP<(2519+500)&BP>(2519-500),p=0.5),which(c14db$RiceRegion=='II'))] <- TRUE
c14db$D500[intersect(which.CalDates(calibrated.dates,BP<(2859+500)&BP>(2859-500),p=0.5),which(c14db$RiceRegion=='III'))] <- TRUE
c14db$D500[intersect(which.CalDates(calibrated.dates,BP<(2773+500)&BP>(2773-500),p=0.5),which(c14db$RiceRegion=='IV'))] <- TRUE
c14db$D500[intersect(which.CalDates(calibrated.dates,BP<(2597+500)&BP>(2597-500),p=0.5),which(c14db$RiceRegion=='V'))] <- TRUE
c14db$D500[intersect(which.CalDates(calibrated.dates,BP<(2220+500)&BP>(2220-500),p=0.5),which(c14db$RiceRegion=='VI'))] <- TRUE
c14db$D500[intersect(which.CalDates(calibrated.dates,BP<(2101+500)&BP>(2101-500),p=0.5),which(c14db$RiceRegion=='VII'))] <- TRUE
c14db$D500[intersect(which.CalDates(calibrated.dates,BP<(2377+500)&BP>(2377-500),p=0.5),which(c14db$RiceRegion=='VIII'))] <- TRUE

c14db$D750[intersect(which.CalDates(calibrated.dates,BP<(2988+750)&BP>(2988-750),p=0.5),which(c14db$RiceRegion=='I'))] <- TRUE
c14db$D750[intersect(which.CalDates(calibrated.dates,BP<(2519+750)&BP>(2519-750),p=0.5),which(c14db$RiceRegion=='II'))] <- TRUE
c14db$D750[intersect(which.CalDates(calibrated.dates,BP<(2859+750)&BP>(2859-750),p=0.5),which(c14db$RiceRegion=='III'))] <- TRUE
c14db$D750[intersect(which.CalDates(calibrated.dates,BP<(2773+750)&BP>(2773-750),p=0.5),which(c14db$RiceRegion=='IV'))] <- TRUE
c14db$D750[intersect(which.CalDates(calibrated.dates,BP<(2597+750)&BP>(2597-750),p=0.5),which(c14db$RiceRegion=='V'))] <- TRUE
c14db$D750[intersect(which.CalDates(calibrated.dates,BP<(2220+750)&BP>(2220-750),p=0.5),which(c14db$RiceRegion=='VI'))] <- TRUE
c14db$D750[intersect(which.CalDates(calibrated.dates,BP<(2101+750)&BP>(2101-750),p=0.5),which(c14db$RiceRegion=='VII'))] <- TRUE
c14db$D750[intersect(which.CalDates(calibrated.dates,BP<(2377+750)&BP>(2377-750),p=0.5),which(c14db$RiceRegion=='VIII'))] <- TRUE
