...
recttext(xl=126.5,xr=130.5,yb=33,yt=34,text=c('1039 BC \n (1251-872 BC)'),rectArgs=list(col=rgb(1,1,1,0.5),border=NA),textArgs=list(cex=0.7))
recttext(xl=131.6,xr=135.6,yb=31,yt=32,text=c(' 570 BC \n (735-430 BC)'),rectArgs=list(col=rgb(1,1,1,0.5),border=NA),textArgs=list(cex=0.7))
recttext(xl=130,xr=134,yb=36.5,yt=37.5,text=c(' 910 BC \n (1061-779 BC)'),rectArgs=list(col=rgb(1,1,1,0.5),border=NA),textArgs=list(cex=0.7))
recttext(xl=135.3,xr=139.3,yb=32.2,yt=33.2,text=c(' 824 BC \n (946-703 BC)'),rectArgs=list(col=rgb(1,1,1,0.5),border=NA),textArgs=list(cex=0.7))
recttext(xl=134,xr=138,yb=38.2,yt=39.2,text=c(' 648 BC \n (754-560 BC)'),rectArgs=list(col=rgb(1,1,1,0.5),border=NA),textArgs=list(cex=0.7))
recttext(xl=139.4,xr=143.4,yb=33.6,yt=34.6,text=c(' 271 BC \n (471-124 BC)'),rectArgs=list(col=rgb(1,1,1,0.5),border=NA),textArgs=list(cex=0.7))
recttext(xl=141.2,xr=143.4,yb=36.5,yt=38,text=c(' 152 BC \n (434 BC \n -42 AD)'),rectArgs=list(col=rgb(1,1,1,0.5),border=NA),textArgs=list(cex=0.7))
recttext(xl=136,xr=140,yb=40.4,yt=41.4,text=c(' 428 BC \n (709-203 BC)'),rectArgs=list(col=rgb(1,1,1,0.5),border=NA),textArgs=list(cex=0.7))
box()
dev.off()
...
legend('topright',legend=as.roman(1:8),title='Region',fill=adjustcolor(main.col,alpha.f = 0.5),cex=1.4,box.lwd = 1,box.col = 1,bg='white')
